...
export default function MusicTracksPage() {
  ...
  const handleSortChange = useCallback(
    (_columnId: string | null, direction: 'asc' | 'desc') => {
      // Map TrackTable's sort direction to Jellyfin API format
      // ColumnId is internal to TrackTable — keep server sort unchanged for full re-fetch
      // The page controls sort via sortBy/sortOrder, TrackTable is just visual
      // We leave TrackTable to sort client-side within current page
    },
    [],
  );
